...
const BACKGROUND = new table.Table("Falkenstein, character questions, background",
...
const APPEARANCE = new table.Table("Falkenstein, character questions, appearance",
...
const PERSONALITY = new table.Table("Falkenstein, character questions, personality",
...
const PREFERENCES = new table.Table("Falkenstein, character questions, preferences",
...
const ALLEGIANCES = new table.Table("Falkenstein, character questions, allegiances",
...
const SKILLS = new table.Table("Falkenstein, character questions, skills",
...
const ROMANCE = new table.Table("Falkenstein, character questions, romance",
...
const FAMILY = new table.Table("Falkenstein, character questions, family",
