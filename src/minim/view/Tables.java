...
public class Tables {
	...
	static final Category CHRONICLES = new Category("World of darkness",
			List.of(new Monster(), Clan.ANARCH, Clan.CAMARILLA, Clan.INDEPENDENT, Clan.RURAL, Clan.SABBAT, Clan.URBAN,
					...
					Changeling.UNSEELIEHOUSES, new Beast(), Beast.FAMILIES, Beast.HUNGER, new Demon(), Demon.FACTION,
					Demon.HOUSE, new Kuejin(), Kuejin.DHARMA, Kuejin.HERETICAL, Kuejin.ORTHODOX, Kuejin.CHI));
